...
Common labels
*/}}
{{- define "switcher-api.labels" -}}
helm.sh/chart: {{ include "switcher-api.chart" . }}
{{ include "switcher-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "switcher-api.selectorLabels" -}}
app.kubernetes.io/name: {{ include "switcher-api.name" . }}
